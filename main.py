...
<style>
    ...
    * { box-sizing: border-box; -webkit-tap-highlight-color: transparent; outline: none; }
    ...
    .content-box:hover { border-color: var(--p); transform: scale(1.01); background: rgba(255,255,255,0.03); }
    ...
    .back-btn:hover { background: var(--p); color: #000; transform: translateY(-4px); box-shadow: 0 8px 25px rgba(0,255,136,0.4); }
...
<body class="fade-in">
    ...
    <div class="container">
        <h1>FONT FLOW</h1>
        <p style="color:#888; margin-bottom:30px;">Transform your text into aesthetic art</p>
        ...
        <div class="content-box">
            ...
            <p style="color:#aaa; line-height:1.7; font-size:0.9rem;">Our tool generates unique combinations that work perfectly for <b>Discord</b>, <b>Roblox</b>, or <b>Social Media</b>. Stand out from the crowd!</p>
        </div>
        <footer>
    ...
    <script>
        ...
        input.oninput = function() {
            ...
            content += `<div class='card strike' onclick="copyDynamic(this, '${val}')"><span>${val}</span><div class='copy-btn'>COPY</div></div>`;
...
<head>
    ...
    <title>About Us - Font Flow</title>""" + FAVICON + COMMON_STYLE + """
</head>
<body class="fade-in">
    <div class="container">
        <h1>ABOUT US</h1>
        <div class="content-box">
            ...
            <p>I started this project to learn modern web technologies like <strong>Python and JavaScript</strong>. My goal was to create a clean, fast, and free font generator for creators, gamers and developers.</p>
            <p>I believe in a web where tools are simple, useful, and respect user privacy. Font Flow is a part of my journey to becoming a professional developer.</p>
        </div>
...
<head>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Contact - Font Flow</title>""" + FAVICON + COMMON_STYLE + """
</head>
<body class="fade-in">
    <div class="container">
        <h1>CONTACT</h1>
...
<head>
    <meta charset="UTF-8"><meta name="viewport" content="width=device-width, initial-scale=1.0">
    <title>Privacy Policy - Font Flow</title>""" + FAVICON + COMMON_STYLE + """
    <style>
...
<body class="fade-in">
    <div class="container" style="max-width: 800px; text-align: left;">
        ...
        <div class="content-box">
            ...
            <p>At <strong>Font Flow</strong>, we are committed to protecting the privacy and safety of our users. This policy explains how we handle data.</p>

            <h2>1. Our Privacy Mission: Zero-Data Collection</h2>
            <p>We operate on a "Privacy-First" principle. Font Flow is a client-side tool, meaning all font transformations happen <strong>locally on your browser</strong>. The text you input is never uploaded to our servers. We don't store what you type.</p>
            ...
            <ul>
                <li><strong>No Registration:</strong> We never ask for names, emails, ages, or any personal identification.</li>
                <li><strong>No Profile Building:</strong> We do not track individual behavior or create user profiles.</li>
                <li><strong>Safe Content:</strong> Our tool only transforms text and does not allow for user-to-user communication, preventing any form of online grooming or bullying.</li>
            </ul>
            <p>If you are a parent and believe your child has provided personal information, please contact us immediately for its removal. However, since we collect nothing, there is usually nothing to remove.</p>

            <h2>3. Log Files</h2>
            <p>Like almost every website, our hosting provider (Render) automatically collects standard log files. This includes IP addresses, browser types, and date stamps. This is used strictly for security and technical maintenance. This data is not linked to your personal identity.</p>

            <h2>4. Third-Party Ads & Cookies</h2>
            <p>We use Google AdSense to show advertisements and Google Analytics to see how many people visit us. These partners may use cookies to serve ads based on your visit. You can disable cookies in your browser settings at any time.</p>

            <h2>5. Data Security</h2>
            <p>We use SSL (HTTPS) encryption to ensure that your connection to our generator is safe and secure. Your data remains private while you browse.</p>

            <h2>6. User Rights (GDPR)</h2>
            <p>If you are from the EEA, you have rights regarding your data. Since we do not collect personal data, we have no data to delete or transfer, but you have the right to browse anonymously.</p>

            <h2>7. External Links</h2>
            <p>Our site may contain links to other sites. We are not responsible for their privacy practices. Please read their policies separately.</p>

            <h2>8. Contact Us</h2>
            <p>Questions? Reach us at <strong>support@fontflow.onrender.com</strong>. We are committed to transparency.</p>
        </div>
